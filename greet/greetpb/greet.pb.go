...
func (*Greeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dc0048a50333c3bc, []int{0}
}
...
func (*GreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dc0048a50333c3bc, []int{1}
}
...
func (*GreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dc0048a50333c3bc, []int{2}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dc0048a50333c3bc, []int{3}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dc0048a50333c3bc, []int{4}
}
...
func init() { proto.RegisterFile("greet/greetpb/greet.proto", fileDescriptor_greet_dc0048a50333c3bc) }

var fileDescriptor_greet_dc0048a50333c3bc = []byte{
